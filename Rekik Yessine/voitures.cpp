...
void Voitures::Ajouter(Ui::mywindow *ui)
{
    Carac_voiture e;
...
void Voitures::Supprimer(Ui::mywindow *ui)
{
    QMessageBox msgbox;
...
void Voitures::Dispo(Ui::mywindow *ui)
{
    {
...
void Voitures::Affecter(Ui::mywindow *ui,carac_trajet e)
{
...
void Voitures::Trajets_Associes(Ui::mywindow *ui, QVector<carac_trajet> T)
{
    if (ui->table_modif->currentRow()>=0)
...
void Voitures::Modifier(Ui::mywindow *ui,int row,int column)
{
    int i=0;
...
void Voitures::Exporter(Ui::mywindow *ui)
{
    QString textData;
...
void Voitures::Load_DB(Ui::mywindow *ui)
{
    Connection C;
    QSqlQuery dbQuery;
